...
var dsy = new Dsy();
var proviClick = false;
var citysClick = false;
var areasClick = false;
var proviNum = null;
var cityNum = null;
$(".provis").on("click", function() {
	citysClick = false;
	areasClick = false;
	var ar = dsy.Items[0];
	if (proviClick == false) {
		for (var i = 0; i < ar.length; i++) {
			$(this).siblings(".provi").append("<p>"+ ar[i] +"</p>");
		}
		proviClick = true;
		$(this).siblings(".provi").css({
			"display" : "block"
		})
	} else {
		$(this).siblings(".provi").css({
	...
	$(this).siblings(".provi").children("p").on("click", function() {
		proviNum = $(this).index();
...
$(".citys").on("click", function() {
	...
	if (citysClick == false) {
		$(this).siblings(".city").children().remove();
		for (var i = 0; i < ar.length; i++) {
			$(this).siblings(".city").append("<p>"+ ar[i] +"</p>");
		}
		citysClick = true;
		$(this).siblings(".city").css({
			"display" : "block"
		})
	} else {
		$(this).siblings(".city").css({
	...
	$(this).siblings(".city").children("p").on("click", function() {
		cityNum = $(this).index();
		$(this).parent().siblings().html($(this).html());
		$(this).parent().css({
			"display" : "none"
...
$(".areas").on("click", function() {
	var str = 0;
	str = ("0_" + proviNum + "_" + cityNum);
	var ar = dsy.Items[str];
	if (ar == "" || ar == null) {
		return false;
	}
	if (areasClick == false) {
		$(this).siblings(".area").children().remove();
		for (var i = 0; i < ar.length; i++) {
			$(this).siblings(".area").append("<p>"+ ar[i] +"</p>");
		}
		areasClick = true;
		$(this).siblings(".area").css({
			"display" : "block"
		})
	} else {
		$(this).siblings(".area").css({
	...
	$(this).siblings(".area").children("p").on("click", function() {
		// cityNum = $(this).index();
		$(this).parent().siblings().html($(this).html());
		$(this).parent().css({
			"display" : "none"
...
$(document).on('click', '*', function(e) {
	e.stopPropagation();
	if(!(this.className == 'provis' || this.className == 'citys' || this.className == 'areas')) {
		$('.provi, .city, .area').css({
			"display" : "none"
		})
		proviClick = false;
